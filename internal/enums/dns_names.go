...
func PacketTypeName(packetType uint8) string {
	...
	case PACKET_RESOLVER_REPORT:
		return "PACKET_RESOLVER_REPORT"
	case PACKET_RESOLVER_LIST_REQUEST:
		return "PACKET_RESOLVER_LIST_REQUEST"
	case PACKET_RESOLVER_LIST_RESPONSE:
		return "PACKET_RESOLVER_LIST_RESPONSE"
	case PACKET_RESOLVER_REPORT_V2:
		return "PACKET_RESOLVER_REPORT_V2"
